...
export default [
  ...
  {name:'台湾', cityList:[
      {name:'台湾', areaList:['台北市','高雄市','基隆市','台中市','台南市','新竹市','嘉义市','宜兰县','桃园县','新竹县','苗栗县','彰化县','南投县','云林县','嘉义县','花莲县']}
  ]},
  {name:'香港', cityList:[
      {name:'香港', areaList:['中西区','东区',' 九龙城区',' 观塘区','南区','深水埗区','黄大仙区','湾仔区','油尖旺区','离岛区',' 葵青区','北区','西贡区','沙田区','屯门区','大埔区','荃湾区',' 元朗区']}
  ]},
  {name:'澳门', cityList:[
      {name:'澳门', areaList:['澳门特别行政区']}
  ]},
  {name:'海外', cityList:[
      {name:'海外', areaList:['海外国家']}
  ]}
];
